        ...
        <div id="header_1">
            ...
            <div id="header_1_right">
               <c:choose>
                ...
                <c:otherwise>
                <!-- 로그인 후 -->
                    <lable>${loginMember.userName}님 환영합니다</label> &nbsp;&nbsp;
...
<body>
    ...
    <c:set var="contextRoot" value="${pageContext.request.contextPath}"></c:set> <!-- 매번 컨텍스트 루트를 적긴 번거로우니 변수로 지정 -->
    <div id="header">
        <div id="header_1">
            <div id="header_1_left">
                <img src="https://www.iei.or.kr/resources/images/common/top_logo_s.jpg" alt="">
    ...
    <div class="modal fade" id="loginModal">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action="${contextRoot}/login.me" method="post"> <!-- 쿼리스트링 노출 X (post 메서드) -->
                    <!-- Modal body -->
                    <div class="modal-body">
                        <label for="userId" class="mr-sm-2">ID : </label>
                        <input type="text" class="form-control mb-2 mr-sm-2" placeholder="Enter ID" id="userId" name="userId"> <br>
                    ...
                    <!-- Modal footer -->
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary">로그인</button> <!-- 로그인 버튼을 눌렀을때 form태그 post 방식 작동함. -->
                        <button type="button" class="btn btn-danger" data-dismiss="modal">취소</button>
                    </div>
                </form>
            </div>
