...
<body>
    ...
    <div class="content">
        ...
        <div class="innerOuter" style="padding:5% 10%;">
            ...
            <!-- 
                choose문과 when을 써서 session에서 로그인 멤버를 갖고오기
                그리고나서 멤버가 만약에 있다? 글쓰기 버튼 보이게하기 
                없다? 안보이게하기 
                경로를 insert.bo 이렇게  
                   
            -->
            
            <!-- 로그인을 안하면 글쓰기 버튼 안보이게하고 만약 했다면 보이게하기 -->
            <c:choose>
            ...
            <div id="pagingArea">
                <ul class="pagination">
                   ...
                   <c:forEach begin="${pi.startPage}" end="${pi.endPage}" var="i">
                      <li class="page-item"><a class="page-link" href="${contextRoot}/list.bo?currentPage=${i}">${i}</a></li>                   
                   </c:forEach>
